...
def main(args, model_args):
    ...
    if args.checkpoint_path != "" or args.resume != None:
        ...
        # ----手动删除形状不匹配的参数 ----
        if 'model' in checkpoint and 'auto_weight.params' in checkpoint['model']:
            print("⚠️ 发现 auto_weight.params 形状不匹配，主动从预训练权重中剔除！")
            del checkpoint['model']['auto_weight.params']
